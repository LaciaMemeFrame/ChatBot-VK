        ...
        if event.text == u'Начать': #or event.text == u'Начать': Если написали заданную фразу
            if event.from_user: #Если написали в ЛС
                vk.messages.send(
                    ...
                    message=u'IP: 34.91.141.151:7777 Полезные ссылки: Наш сайт - laciamemeframe.space (Сайт создателя проекта, так как сайт самого сервера находится в разработке). Форум - В разработке, Группа "Вконтакте" - https://vk.com/pixsetup, Свободная группа "Вконтакте" - В разработке. IP: 34.91.233.9:7777'
